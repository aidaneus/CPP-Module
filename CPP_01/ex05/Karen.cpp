...
std::string Karen::_slevel[4] = {"DEBUG", "INFO", "WARNING", "ERROR"};
...
Karen::Karen(void)
{
    _flevel[0] = &Karen::debug;
    _flevel[1] = &Karen::info;
    _flevel[2] = &Karen::warning;
    _flevel[3] = &Karen::error;
}